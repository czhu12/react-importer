...
| sampleFileUrl                   | -                                                        | string                                                                           | No       | URL to a downloadable sample file that users can use as a template. The URL should point directly to the file (e.g., https://example.com/sample.csv) and be served with appropriate download headers. |
