  ...
  return <div>
    <Margin margin="60px" style={{textAlign: 'center'}}>
      <div style={{width: "100px", height: "100px", margin: "0 auto", position: "relative"}}>
        <svg style={{position: "absolute", margin: "auto", top: "0", bottom: "0", left: "0", right: "0"}} xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#e74c3c" className="bi bi-x-lg" viewBox="0 0 16 16">
    ...
    <Margin margin="60px" style={{textAlign: 'center'}}>
      <div style={{width: "100px", height: "100px", margin: "0 auto", position: "relative"}}>
        <CircularProgressbarWithChildren
          ...
          styles={buildStyles({
            // Colors
            pathColor: `rgba(46, 204, 113, ${progress / 100})`,
          })}
        >
          {!pending && (
            <SuccessIcon />
