...
const MappingStatistics = ({
  ...
  fieldStatistics: ImporterFieldStatistics;
  selectedField: ImporterHeaderMappingEntrySelectedField;
}) => {
  ...
  return (
    <div>
      {selectedField && (
        <div>
          Matched to <b>{selectedField.label}</b>
        </div>
      )}
      {!selectedField && (
        <div>
          <b>No match detected</b>
        </div>
      )}
      <br />
      <div>
...
const HeaderMapperSelection = ({
  ...
  selectedHeader: ImporterHeaderMappingEntrySelectedField | null;
  setHeader: (header: ImporterHeaderMappingEntrySelectedField | null) => void;
  options: ImporterHeaderMappingEntrySelectedField[];
}) => {
  return (
    <div>
      <Margin margin="20px 0">
        <Row>
          ...
          <Col>
            <Select<ImporterHeaderMappingEntrySelectedField>
              isClearable
              isSearchable
...
const HeaderMapperRow = ({
  ...
  header: string;
  examples: ImporterOutputFieldType[];
  headerMapping: ImporterHeaderMappingEntry;
  setHeaderMapping: (mapping: ImporterHeaderMappingEntry) => void;
  fieldStatistics: ImporterFieldStatistics;
}) => {
  let block = null;
  const theme = useTheme();
      ...
      <Row>
        <Col>
          <Row>
            ...
            <Col>
              <Select isDisabled value={headerMapping.selectedField} />
            </Col>
          </Row>
        </Col>
