      ...
      sheets={[
        {
          ...
          columns: [
            ...
            { label: 'Phone Number', id: 'phone_number', type: 'string', validators: [{ validate: 'required' }] },
            { label: 'Address', id: 'address', type: 'string', validators: [{ validate: 'required' }] },
            { label: 'City', id: 'city', type: 'string' },
            { label: 'State', id: 'state', type: 'string', transformers: [{ transformer: 'state_code' }] },
            { label: 'Zip Code', id: 'zip_code', type: 'string', validators: [{ validate: 'required' }] },
          ],
        },
      ]}
